...
urlpatterns = [
    ...
    path('getassignments/course/<int:course_id>/', views.get_assignments_one_course),
    ...
    path('educator/getcourses/<int:educator_id>/', views.get_courses_educator),
    path('educator/getassignments/<int:educator_id>/', views.get_assignments_educator),
